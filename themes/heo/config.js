const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-04-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到数字游民生活指南', url: '/' },
    { title: 'Welcome to the Digital Nomad Life Guide', url: '/' }
  ],
